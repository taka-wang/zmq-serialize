...
void   mb_tcp_multiple_write_req__init
                     (MbTcpMultipleWriteReq         *message)
{
  static MbTcpMultipleWriteReq init_value = MB_TCP_MULTIPLE_WRITE_REQ__INIT;
  *message = init_value;
}
size_t mb_tcp_multiple_write_req__get_packed_size
                     (const MbTcpMultipleWriteReq *message)
{
  assert(message->base.descriptor == &mb_tcp_multiple_write_req__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
size_t mb_tcp_multiple_write_req__pack
                     (const MbTcpMultipleWriteReq *message,
                      uint8_t       *out)
{
  assert(message->base.descriptor == &mb_tcp_multiple_write_req__descriptor);
...
size_t mb_tcp_multiple_write_req__pack_to_buffer
                     (const MbTcpMultipleWriteReq *message,
                      ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &mb_tcp_multiple_write_req__descriptor);
...
MbTcpMultipleWriteReq *
       mb_tcp_multiple_write_req__unpack
                     (ProtobufCAllocator  *allocator,
                      size_t               len,
                      const uint8_t       *data)
{
  return (MbTcpMultipleWriteReq *)
     protobuf_c_message_unpack (&mb_tcp_multiple_write_req__descriptor,
                                allocator, len, data);
}
void   mb_tcp_multiple_write_req__free_unpacked
                     (MbTcpMultipleWriteReq *message,
                      ProtobufCAllocator *allocator)
{
  assert(message->base.descriptor == &mb_tcp_multiple_write_req__descriptor);
...
static const ProtobufCFieldDescriptor mb_tcp_multiple_write_req__field_descriptors[3] =
{
  {
    "cmd_header",
    1,
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    offsetof(MbTcpMultipleWriteReq, cmd_header),
    &cmd_header__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    offsetof(MbTcpMultipleWriteReq, mb_tcp_header),
    &mb_tcp_header__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    offsetof(MbTcpMultipleWriteReq, n_requests),
    offsetof(MbTcpMultipleWriteReq, requests),
    &mb_write_request__descriptor,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned mb_tcp_multiple_write_req__field_indices_by_name[] = {
  0,   /* field[0] = cmd_header */
  1,   /* field[1] = mb_tcp_header */
  2,   /* field[2] = requests */
};
static const ProtobufCIntRange mb_tcp_multiple_write_req__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 3 }
};
const ProtobufCMessageDescriptor mb_tcp_multiple_write_req__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "MbTcpMultipleWriteReq",
  "MbTcpMultipleWriteReq",
  "MbTcpMultipleWriteReq",
  "",
  sizeof(MbTcpMultipleWriteReq),
  3,
  mb_tcp_multiple_write_req__field_descriptors,
  mb_tcp_multiple_write_req__field_indices_by_name,
  1,  mb_tcp_multiple_write_req__number_ranges,
  (ProtobufCMessageInit) mb_tcp_multiple_write_req__init,
  NULL,NULL,NULL    /* reserved[123] */
};